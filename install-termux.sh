...
echo "   3. RUN-WEB.py   -> ควบคุมผ่านหน้าเว็บ (Web Interface)"
echo "   4. index.html   -> ไฟล์หน้าเว็บหลัก"
echo "   5. favicon.jpg  -> หน้าปกเว็บไซต์"
echo "   6. update.sh    -> ใช้อัปเดตโปรแกรม"
echo "   7. API-Test.py  -> ใช้ทดสอบ API ยิงเบอร์"
echo ""
echo "📥 วิธีอัปเดต:"
